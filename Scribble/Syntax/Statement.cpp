...
Modules const& Project::modules() const
{
    return m_modules;
}

std::shared_ptr<Module> const& Project::root() const
{
    return m_root;
}
...
std::string Project::attributes() const
{
...
std::string Project::root_to_xml() const
{
    auto indent = 0;
